...
<html lang="en">
  ...
  <script type="text/javascript">
			$(function() {
				...
				$("#information li:eq(1)").addClass("active");
			})
		</script>  
  </head>
  <body>
...
<div id="selectAll">
 <form id="selectForm">
         名字：
   <input type="text" class="" value="" style="width: 150px;height: 28px" name="name" >
        电话：
   <input type="text" class="" value="" style="width: 150px;height: 28px" name="tel"  >
        身份证：
   <input type="text" class="" value="" style="width: 150px;height: 28px" name="idCard"  >
