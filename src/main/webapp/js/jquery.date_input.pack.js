	...
	DateInput.prototype = {
		build: function() {
			...
			if ($.browser.msie && $.browser.version < 7) {
				this.ieframe = $('<iframe class="date_selector_ieframe" frameborder="0" src="#" style="top:0px;left:500px"></iframe>').insertBefore(this.dateSelector);
		...
		setPosition: function() {
			...
			this.rootLayers.css({
				top: offset.top + this.input.outerHeight()-40,
