...
<html lang="en">
  ...
  <script type="text/javascript">
			$(function() {
				$("#information").addClass("in");
				$("div#menu ul li").removeClass("active");
				$("#information li:eq(0)").addClass("active");
			})
		</script>   
  </head>
  <body>
...
<div id="selectAll">
 <form id="selectForm">
         房间：
   <input type="text" class="" value="" style="width: 150px;height: 28px" name="rname" >
        租客：
   <input type="text" class="" value="" style="width: 150px;height: 28px" name="renterName"  >
      
    状态：  <select name="statuss" style="width: 150px;height: 28px" >
     <option value=""></option>
     <option value="空闲">空闲</option>
     <option value="租赁中">租赁中</option>
    </select>
    价格：  <input type="text"   name="price"  class="" value="" style="width: 150px;height: 28px"  >
     房间大小：  <input type="text"   name="size"  class="" value="" style="width: 150px;height: 28px"  >
 (支持模糊查询) 
 </form>   
